...
|------|--------|-----------------|
| 1 | User enters a very long string of characters (e.g., 'a' 200+ times) into password field. | The input field prevents the user from typing more than defined limit of characters (e.g., 100). |