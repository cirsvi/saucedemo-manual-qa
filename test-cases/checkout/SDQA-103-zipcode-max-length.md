...
| 4 | Click the "Continue" button in the bottom right corner. | The server rejects the request and displays an error message: "Zip code must be under 10 characters." and the input field is highlighted in red color. |