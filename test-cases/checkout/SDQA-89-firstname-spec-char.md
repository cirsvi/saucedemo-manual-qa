# SDQA-89: SauceDemo | Checkout | Server-side: First name input does not accept special characters

| Field             | Detail |
|-------------------|--------|
| **Test Case ID**  | SDQA-89 |
| **Priority**      | Low |
...
| 4 | User clicks the "Continue" button in the bottom right corner. | The server rejects the request and displays an error message: "First Name must contain only letters, spaces, and hyphens." and the input field is highlighted in red color. |