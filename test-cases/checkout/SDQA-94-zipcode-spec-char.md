...
| 4 | Click the "Continue" button in the bottom right corner. | The server rejects the request and displays an error message: "Zip code must contain only letters and numbers." and the input field is highlighted in red color. |