# SDQA-128: SauceDemo | Checkout | UX |  Checkout "First Name" field accepts special characters
...
| **Build Version**  | V1.0 |
| **Environment**    | PROD |
| **Linked Test Case** | [SDQA-89](../../test-cases/checkout/SDQA-89-firstname-spec-char.md) – SauceDemo \| Checkout \| Server-side: First name input does not accept special characters |
...
|--------|-----------------|---------------|
| User inputs a string of special characters (e.g., "@&$^@%") into the "First Name" input field. | The "First Name" input field displays entered string (e.g., "@&$^@%"). | - |
...
## Attachments:
![First name with special characters input](../../evidence/firstname_spec_char.gif)