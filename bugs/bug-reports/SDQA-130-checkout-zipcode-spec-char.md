...
| **Build Version**  | V1.0 |
| **Environment**    | PROD |
| **Linked Test Case** | [SDQA-94](../../test-cases/checkout/SDQA-94-zipcode-spec-char.md) – SauceDemo \| Checkout \| Server-side: Zip Code input does not accept special characters |
