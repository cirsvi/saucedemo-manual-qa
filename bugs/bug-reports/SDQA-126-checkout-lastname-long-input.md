# SDQA-126: SauceDemo | Checkout | UX |  Checkout "Last Name" field accepts infinite amount of characters
...
| User inputs a really long string (e.g., letter a 200+ times) into the "Last Name" input field. | The "Last Name" input field displays entered string (e.g., letter a 200+ times). | - |
...
| User clicks the "Continue" button in the bottom right corner. |The server rejects the request and displays an error message: "Last Name must be under 50 characters." and the input field is highlighted in red color. | The "Last Name" input of long string is accepted and the user is redirected to the "Checkout: Overview" page; no error message displayed (see video in  Attachments). |
